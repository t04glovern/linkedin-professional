...
CLIENT_ID    = client.get_parameter(Name='devopstar-linkedin-client-id')['Parameter']['Value']
...
def get_access_token():
    AUTH_CODE           = client.get_parameter(Name='devopstar-linkedin-auth-code')['Parameter']['Value']
    CLIENT_SECRET       = client.get_parameter(Name='devopstar-linkedin-client-secret')['Parameter']['Value']
...
def test_linkedin_api():
    ACCESS_TOKEN   = client.get_parameter(Name='devopstar-linkedin-access-token')['Parameter']['Value']
